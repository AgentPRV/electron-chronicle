...
function returnPanelDiv(row) {
  return `<div class="panel panel-default" id="panel`+row.id+`">
  <div class="panel-heading">
    ...
    <button type="button" class="btn btn-danger act-btns" onclick="deleteNote(`+row.id+`)"> <span class="glyphicon glyphicon-trash"></span></button>
  </div>
